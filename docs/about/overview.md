...
| Concept                   | Description                                                                                                                                                                                                                                                          |
| ------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Agent**                 | A Maestro workspace tied to a project directory, backed by a provider (e.g., Claude Code, Codex, or OpenCode). Each agent has a Command Terminal and AI Terminal.                                                                                                    |
| **Provider**              | The underlying AI coding assistant (Claude Code, OpenAI Codex, OpenCode, Factory Droid, Copilot-CLI, or Gemini CLI) that powers an agent.                                                                                                                            |
...
| **Provider Pass-Through** | Maestro delegates all AI work to your installed provider (e.g., Claude Code, Codex, OpenCode). Your MCP tools, custom skills, permissions, and authentication all carry over—Maestro runs them in batch mode (prompt in, response out) rather than interactive mode. |
