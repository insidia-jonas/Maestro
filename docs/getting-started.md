...
Maestro supports **Claude Code**, **Codex** (OpenAI), **OpenCode**, **Factory Droid**, **Copilot-CLI** (beta), and **Gemini CLI** (beta) as providers. Make sure at least one is installed and authenticated.
