...
Run multiple agents in parallel with a Linear/Superhuman-level responsive interface. Currently supporting **Claude Code**, **OpenAI Codex**, **OpenCode**, **Factory Droid**, **Copilot-CLI** (beta), and **Gemini CLI** (beta).
...
> **Note**: Maestro supports Claude Code, OpenAI Codex, OpenCode, Factory Droid, Copilot-CLI (beta), and Gemini CLI (beta).
...
- At least one supported AI coding agent installed and authenticated:
  ...
  - [Factory Droid](https://docs.factory.ai/cli) - Factory's AI coding assistant
  ...
  - [Gemini CLI](https://github.com/google-gemini/gemini-cli) - Google's terminal coding agent (beta)
