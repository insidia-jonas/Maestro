...
describe('agent-detector', () => {
	...
	describe('detectAgents', () => {
		...
		it('should detect all defined agent types', async () => {
			...
			// Should have all 9 agents (terminal, claude-code, codex, gemini-cli, qwen3-coder, opencode, factory-droid, copilot-cli, grok-build)
			...
			expect(agentIds).toContain('grok-build');
		});
